...
#First time step
    ...
    if Seconds<=2:
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre2.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3200)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3200)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3200)+1])
        for k in pre2:
            pre21.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre21:
            pre22.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre3.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3300)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3300)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3300)+1])
        for k in pre3:
                pre31.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre31:
                pre32.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre4.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3400)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3400)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3400)+1])
        for k in pre4:
                pre41.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre41:
                pre42.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for k in pre6:
                pre61.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre61:
                pre62.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre7.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3700)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3700)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3700)+1])
        for k in pre7:
                pre71.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre71:
                pre72.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre8.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3800)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3800)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3800)+1])
        for k in pre8:
                pre81.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre81:
                pre82.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre9.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/3900)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/3900)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/3900)+1])
        for k in pre9:
                pre91.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre91:
                pre92.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre10.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/31000)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/31000)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/31000)+1])
        for k in pre10:
                pre101.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre101:
                pre102.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
        ...
        for i in kios:
            ...
            fot = ((kg1+kg2+kg3+kg4)/St)/CLength            
            pre11.append([kg1,kg2+ round(((kg1/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(i[1]).AttValue ('ArrivalRate')/31100)+1,kg3 +round(((kg1+kg2/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(i[2]).AttValue ('ArrivalRate')/31100)+1, kg4+round(((kg1+kg2+kg3/ St)/fot)*Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(i[3]).AttValue ('ArrivalRate')/31100)+1])
        for k in pre11:
                pre111.append([round((k[0]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[1]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[2]/(k[1]+k[2]+k[3]+k[0]))*(CLength)), round((k[3]/(k[1]+k[2]+k[3]+k[0]))*(CLength))])
        for m in pre111:
                pre112.append([0, m[0], m[0] + m[1], m[0] + m[1]+ m[2]])
            ...
            while bo < len(mth2)-1:
                ...
                for kkk in range(len(mth2[bo])):
                    for jjj in range(len(mth2[bo+1])):
                        klj = abs(mth2[bo][kkk] + qth2[bo][kkk] / St - mth2[bo+1][jjj] + 10)
...
# circling signals
    ...
    if Seconds >2:
        ...
        if Seconds <=5:
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][0]).SetAttValue ('GreenTimeDuration',60)
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).SetAttValue ('GreenTimeDuration',20)
                        

            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).SetAttValue ('GreenTimeDuration',20)
            

            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][0]).SetAttValue ('GreenTimeDuration',60)
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][3]).SetAttValue ('GreenTimeDuration',20)



            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).SetAttValue ('GreenTimeDuration',20)


            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).SetAttValue ('GreenTimeDuration',20)

            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][0]).SetAttValue ('GreenTimeDuration',60)
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][3]).SetAttValue ('GreenTimeDuration',20)


            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][0]).SetAttValue ('GreenTimeDuration',60)
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][1]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][2]).SetAttValue ('GreenTimeDuration',20)
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][3]).SetAttValue ('GreenTimeDuration',20)
            ...
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][1]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][2]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(Aseq[0][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][1]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][2]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(Aseq[4][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).AttValue ('GreenEnd'))
            ...
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][1]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][2]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(Aseq[11][3]).SetAttValue ('GreenEnd', CLength)
            ...
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][1]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][2]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][3]).SetAttValue ('GreenStart',Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][0]).AttValue ('GreenEnd'))
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][1]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][2]).SetAttValue ('GreenEnd', CLength)
            Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(Aseq[12][3]).SetAttValue ('GreenEnd', CLength)
        ...
        for sig in SignalAttributes11:               
            if  Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(11).SGs.ItemByKey(Aseq[10][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(10).SGs.ItemByKey(Aseq[9][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(9).SGs.ItemByKey(Aseq[8][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(8).SGs.ItemByKey(Aseq[7][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(7).SGs.ItemByKey(Aseq[6][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(6).SGs.ItemByKey(Aseq[5][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(4).SGs.ItemByKey(Aseq[3][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(3).SGs.ItemByKey(Aseq[2][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).AttValue ('GreenEnd'):                 
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).AttValue ('GreenEnd'):             
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).AttValue ('SigState') == 'GREEN':
                ...
                Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).SetAttValue ('SigState','RED')
                Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).AttValue ('GreenEnd'):                 
                        Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][0]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][1]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][2]).SetAttValue ('SigState','RED')
                        Vissim.Net.SignalControllers.ItemByKey(2).SGs.ItemByKey(Aseq[1][3]).SetAttValue ('SigState','RED')
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(1).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(1).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(1).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(2).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(2).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(1).SGs.ItemByKey(2).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(1).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(1).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(1).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(2).AttValue ('SigState') == 'GREEN':
                Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(1).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(2).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(5).SGs.ItemByKey(2).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(1).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(1).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(1).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(2).AttValue ('SigState') == 'GREEN':
                Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(1).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(2).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(12).SGs.ItemByKey(2).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(1).AttValue ('SigState') == 'GREEN':
                ...
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(1).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(1).AttValue ('GreenEnd'):
            ...
            if  Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(2).AttValue ('SigState') == 'GREEN':
                Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(1).SetAttValue ('SigState','RED')
                if Seconds >= Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(2).AttValue ('GreenEnd')-2:
                    if Seconds <= Vissim.Net.SignalControllers.ItemByKey(13).SGs.ItemByKey(2).AttValue ('GreenEnd'):
